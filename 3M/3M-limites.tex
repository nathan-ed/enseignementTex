...
\insertexo{1n93r}{true}{both}
\insertexo{59swy}{true}{both}
\insertexo{qp2mw}{true}{both}
\insertexo{6csvs}{true}{both}
\subsection{Limites en un nombre}
\insertexo{4dptb}{true}{both}
\insertexo[exo:p1f]{g4gbb}{true}{both}
\insertexo{n9sxp}{true}{both}
\insertexo[exo:p2d]{tecfn}{true}{both}
\insertexo{wnd21}{true}{both}
\insertexo{3vr28}{true}{both}
\insertexo{c3uc9}{true}{both}
\insertexo{1bqh9}{true}{both}
\insertexo{myjcq}{true}{both}
\insertexo{dpjwk}{true}{both}
\insertexo{97ryj}{true}{both}
\insertexo{n1axs}{true}{both}

\insertexo{gb3ag}{true}{both}
\insertexo{5911p}{true}{both}

\insertexo{hsytn}{true}{both}
\subsubsection{Indétermination du type « $\dfrac{0}{0}$ » et « $\dfrac{1}{0}$ » }

\insertexo[exo:p1d]{vyj67}{true}{both}
\insertexo{ac9v2}{true}{both}
\insertexo{98752}{true}{both}
\insertexo{gg7hk}{true}{both}
\insertexo{f7dft}{true}{both}
\insertexo{u44h9}{true}{both}
\insertexo{pp62m}{true}{both}
\insertexo{b3p6g}{true}{both}
\insertexo{n41yn}{true}{both}
\insertexo{8j18h}{true}{both}
\insertexo{yhzh8}{true}{both}
\insertexo{9yqnb}{true}{both}
%--> corrigés vérifiés après ici.
\insertexo{k3bry}{true}{both}
\insertexo{1w6s3}{true}{both}
\insertexo{nxc2s}{true}{both}
\subsubsection{Asymptotes verticales}
\insertexo{89av7}{true}{both}
\insertexo{1w3pd}{true}{both}
\subsection{Limites en l'infini}
\insertexo{x5h3r}{true}{both}
\insertexo{n9qmn}{true}{both}
\insertexo{t4gwt}{true}{both}
\insertexo{bqknk}{true}{both}
\insertexo{du7be}{true}{both}
\insertexo{6qym1}{true}{both}
\insertexo{aatq8}{true}{both}
\insertexo{gm9uk}{true}{both}
\insertexo{taje8}{true}{both}
\insertexo{y4dv7}{true}{both}
\insertexo{y4385}{true}{both}
\insertexo{2at6d}{true}{both}
\insertexo{mj5qq}{true}{both}
\insertexo{hgcu8}{true}{both}
\insertexo{ek51g}{true}{both}
%MA2\insertexo{us8px}{true}{both}
\insertexo{5en1r}{true}{both}
\insertexo{1gayt}{true}{both}
\insertexo{955md}{true}{both}
\insertexo{mkn1h}{true}{both}
\insertexo{pzy7s}{true}{both}
\insertexo{3yjzh}{true}{both}

\subsection{Limites de fonctions trigonométriques}
\insertexo{byf5j}{true}{both}
\insertexo{h9w1s}{true}{both}
\insertexo{jqhm4}{true}{both}
...
%\insertexo{4dptb}{true}{both}
%\insertexo[exo:p1f]{g4gbb}{true}{both}
%%\insertexo{extez}{true}{both}
%%\insertexo{znghn}{true}{both}
%\insertexo[exo:p2d]{tecfn}{true}{both}
%%\insertexo{fazjq}{true}{both}
%\insertexo{f7dft}{true}{both}
%\insertexo{ac9v2}{true}{both}
%\insertexo{nxc2s}{true}{both}
%\insertexo{n9qmn}{true}{both}
