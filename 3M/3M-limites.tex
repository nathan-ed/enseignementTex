...
\insertexo{1M-1n93r}{true}{both}
\insertexo{1M-59swy}{true}{both}
\insertexo{1M-qp2mw}{true}{both}
\insertexo{1M-6csvs}{true}{both}
\subsection{Limites en un nombre}
\insertexo{1M-4dptb}{true}{both}
\insertexo[exo:p1f]{1M-g4gbb}{true}{both}
\insertexo{1M-n9sxp}{false}{both}
\insertexo[exo:p2d]{1M-tecfn}{true}{both}
\insertexo{1M-wnd21}{true}{both}
\insertexo{1M-3vr28}{true}{both}
\insertexo{1M-c3uc9}{true}{both}
\insertexo{1M-1bqh9}{true}{both}
\insertexo{1M-myjcq}{true}{both}
\insertexo{1M-dpjwk}{true}{both}
\insertexo{1M-97ryj}{true}{both}
\insertexo{1M-n1axs}{true}{both}

\insertexo{1M-gb3ag}{true}{both}
\insertexo{1M-5911p}{true}{both}

\insertexo{1M-hsytn}{false}{both}
\subsubsection{Indétermination du type « $\dfrac{0}{0}$ » et « $\dfrac{1}{0}$ » }

\insertexo[exo:p1d]{1M-vyj67}{true}{both}
\insertexo{1M-ac9v2}{true}{both}
\insertexo{1M-98752}{true}{both}
\insertexo{1M-gg7hk}{true}{both}
\insertexo{1M-f7dft}{true}{both}
\insertexo{1M-u44h9}{false}{both}
\insertexo{1M-pp62m}{false}{both}
\insertexo{1M-b3p6g}{true}{both}
\insertexo{1M-n41yn}{true}{both}
\insertexo{1M-8j18h}{true}{both}
\insertexo{1M-yhzh8}{true}{both}
\insertexo{1M-9yqnb}{true}{both}
%--> corrigés vérifiés après ici.
\insertexo{1M-k3bry}{true}{both}
\insertexo{1M-1w6s3}{true}{both}
\insertexo{1M-nxc2s}{true}{both}
\subsubsection{Asymptotes verticales}
\insertexo{1M-89av7}{true}{both}
\insertexo{1M-1w3pd}{true}{both}
\subsection{Limites en l'infini}
\insertexo{1M-x5h3r}{true}{both}
\insertexo{1M-n9qmn}{true}{both}
\insertexo{1M-t4gwt}{true}{both}
\insertexo{1M-bqknk}{true}{both}
\insertexo{1M-du7be}{true}{both}
\insertexo{1M-6qym1}{true}{both}
\insertexo{1M-aatq8}{true}{both}
\insertexo{1M-gm9uk}{true}{both}
\insertexo{1M-taje8}{true}{both}
\insertexo{1M-y4dv7}{true}{both}
\insertexo{1M-y4385}{true}{both}
\insertexo{1M-2at6d}{true}{both}
\insertexo{1M-mj5qq}{true}{both}
\insertexo{1M-hgcu8}{true}{both}
\insertexo{1M-ek51g}{true}{both}
%MA2\insertexo{1M-us8px}{false}{both}
\insertexo{1M-5en1r}{true}{both}
\insertexo{1M-1gayt}{true}{both}
\insertexo{1M-955md}{true}{both}
\insertexo{1M-mkn1h}{false}{both}
\insertexo{1M-pzy7s}{false}{both}
\insertexo{1M-3yjzh}{false}{both}

\subsection{Limites de fonctions trigonométriques}
\insertexo{1M-byf5j}{true}{both}
\insertexo{1M-h9w1s}{true}{both}
\insertexo{1M-jqhm4}{true}{both}


%Pas inclus 
%\insertexo[exo:p1d]{1M-vyj67}{false}{both}
%\insertexo{1M-4dptb}{false}{both}
%\insertexo[exo:p1f]{1M-g4gbb}{false}{both}
%%\insertexo{1M-extez}{false}{both}
%%\insertexo{1M-znghn}{false}{both}
%\insertexo[exo:p2d]{1M-tecfn}{false}{both}
%%\insertexo{1M-fazjq}{false}{both}
%\insertexo{1M-f7dft}{false}{both}
%\insertexo{1M-ac9v2}{false}{both}
%\insertexo{1M-nxc2s}{false}{both}
%\insertexo{1M-n9qmn}{false}{both}
%\insertexo{1M-bqknk}{false}{both}
%\insertexo{1M-gg7hk}{false}{both}
%\insertexo{1M-n41yn}{false}{both}
%\insertexo{1M-8j18h}{false}{both}
%\insertexo{1M-1w3pd}{false}{both}
%\insertexo{1M-x5h3r}{false}{both}
%\insertexo{1M-1bqh9}{false}{both}
%\insertexo{1M-du7be}{false}{both}
%\insertexo{1M-k3bry}{false}{both}
%\insertexo{1M-gm9uk}{false}{both}
%\insertexo{1M-taje8}{false}{both}
%\insertexo{1M-3vr28}{false}{both}
%\insertexo{1M-gb3ag}{false}{both}
%\insertexo{1M-c3uc9}{false}{both}
%\insertexo{1M-myjcq}{false}{both}
%\insertexo{1M-dpjwk}{false}{both}
%\insertexo{1M-97ryj}{false}{both}
%\insertexo{1M-n1axs}{false}{both}
%\insertexo{1M-wnd21}{false}{both}
%\insertexo{1M-98752}{false}{both}
%\insertexo{1M-t4gwt}{false}{both}
%\insertexo{1M-1w6s3}{false}{both}
%\insertexo{1M-yhzh8}{false}{both}
%\insertexo{1M-9yqnb}{false}{both}
%\insertexo{1M-byf5j}{false}{both}
%\insertexo{1M-h9w1s}{false}{both}
%\insertexo{1M-jqhm4}{false}{both}
%\insertexo{1M-1n93r}{false}{both}
%\insertexo{1M-qp2mw}{false}{both}
%\insertexo{1M-6qym1}{false}{both}
%\insertexo{1M-aatq8}{false}{both}
\newpage
