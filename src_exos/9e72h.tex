...
\contenu{
\tcblower
	Pour chacune des expressions suivantes, préciser (sous : \enquote{Type}) s'il s'agit d'une somme ou d'un produit, et donner le nombre de termes ou de facteurs.
\begin{center}
...
\begin{tasks} (3)
	...
	\task produit, quatre facteurs
	\task somme, deux termes
	\task produit, trois facteurs
	\task somme, deux termes
	\task produit, deux facteurs
	\task somme, deux termes
	\task somme, deux termes
\end{tasks}
}
