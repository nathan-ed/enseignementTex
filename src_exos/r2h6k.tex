...
\[
y=-\dfrac{1}{4}(x-2)+\dfrac{1}{4}=-\dfrac{1}{4}x+\dfrac{1}{2}+\dfrac{1}{4}=-\dfrac{1}{4}x+\dfrac{3}{4}
\]

\task On cherche $a$ tel que $f'(a)=\dfrac{1}{4}$.

\[
-\dfrac{2}{a^3}=\dfrac{1}{4} \quad\Rightarrow\quad a^3=-8 \quad\Rightarrow\quad a=-2
\]
...
\[
y=f'(a)(x-a)+f(a)=-\dfrac{2}{a^3}(x-a)+\dfrac{1}{a^2}
\]

Cette tangente passe par $\left(\dfrac{1}{2},2\right)$, donc :
\[
2=-\dfrac{2}{a^3}\left(\dfrac{1}{2}-a\right)+\dfrac{1}{a^2}=-\dfrac{1}{a^3}+\dfrac{2}{a^2}+\dfrac{1}{a^2}=-\dfrac{1}{a^3}+\dfrac{3}{a^2}
\]

En multipliant par $a^3$ :
\[
