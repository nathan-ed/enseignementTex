...
\correction{
	...
	Par similitude :
	\[\dfrac{BD}{AB} = \dfrac{AB}{AE}\]

	$AE$ avec Pythagore dans le triangle $ABE$ :
	\[AE^2 = AB^2 + BE^2 = 60^2 + 100^2 = 3600 + 10000 = 13600\]
	\[AE = \sqrt{13600} = 20\sqrt{34} \approx 116{,}62 \text{ cm}\]

	
	\[\dfrac{BD}{60} = \dfrac{60}{116{,}62}\]
	\[BD = \dfrac{60 \times 60}{116{,}62} = \dfrac{3600}{116{,}62} \approx 30{,}86 \text{ cm}\]

	De même, par similitude :
	\[\dfrac{AD}{AB} = \dfrac{AB}{AE}\]
	\[AD = \dfrac{AB^2}{AE} = \dfrac{60^2}{116{,}62} = \dfrac{3600}{116{,}62} \approx 30{,}86 \text{ cm}\]

	Et finalement :
	\[\dfrac{DE}{BE} = \dfrac{AB}{AE}\]
	\[DE = \dfrac{AB \times BE}{AE} = \dfrac{60 \times 100}{116{,}62} = \dfrac{6000}{116{,}62} \approx 51{,}44 \text{ cm}\]

	La longueur de $\overline{DE}$ est donc $\boxed{51{,}44 \text{ cm}}$ (ou plus précisément $\dfrac{3000\sqrt{34}}{34} = \dfrac{1500\sqrt{34}}{17}$ cm).
