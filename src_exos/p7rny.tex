...
un tronc d'arbre de section circulaire de rayon $R$. Nous voulons tailler une poutre de section rectangulaire de largeur $x$ et de hauteur $y$.
...
Puisque $u > 0$, nous avons $8R^2 - 3u = 0$, 
\[u = \dfrac{8R^2}{3}\]

Donc $y^2 = \dfrac{8R^2}{3}$, ce qui donne $y = \dfrac{2\sqrt{2}R}{\sqrt{3}} = \dfrac{2\sqrt{6}R}{3}$.

La largeur correspondante est :
\[x^2 = 4R^2 - y^2 = 4R^2 - \dfrac{8R^2}{3} = \dfrac{12R^2 - 8R^2}{3} = \dfrac{4R^2}{3}\]
\[x = \dfrac{2R}{\sqrt{3}} = \dfrac{2\sqrt{3}R}{3}\]

Le rapport entre largeur et hauteur est :
\[\dfrac{x}{y} = \dfrac{\dfrac{2\sqrt{3}R}{3}}{\dfrac{2\sqrt{6}R}{3}} = \dfrac{2\sqrt{3}R}{2\sqrt{6}R} = \dfrac{\sqrt{3}}{\sqrt{6}} = \dfrac{1}{\sqrt{2}} = \dfrac{\sqrt{2}}{2}\]

La poutre la plus résistante a donc un rapport $\boxed{\dfrac{x}{y} = \dfrac{1}{\sqrt{2}}}$, c'est-à-dire que la hauteur doit être $\sqrt{2}$ fois la largeur : $y = \sqrt{2} \cdot x$.
