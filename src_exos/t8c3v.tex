...
\[
y=f'(a)(x-a)+f(a) \iff y=(4a-3)(x-a)+2a^2-3a
\]
...
\item Équation : $y=5(x-2)+2$ d'où $y=5x-8$
\end{itemize}
...
\item Équation : $y=-11(x-(-2))+14$ d'où $y=-11x-8$
\end{itemize}

Les tangentes ont pour équation $y=5x-8$ et $y=-11x-8$.
\end{tasks}
}
